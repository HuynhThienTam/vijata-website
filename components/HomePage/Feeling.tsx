export default function Feeling() {
  return (
    <section className="w-[90%] mx-auto py-8 flex items-start gap-x-6 text-gray-700">
      ...
      <article>
        ...
        <br />
        <p className="text-base indent-8 pl-3 ">
          Quá trình học tập của chúng em được theo dõi sát sao bởi thầy Hsueh
          Kuo Chuen (薛國權) và cô Kim Thoa– những người không chỉ giỏi chuyên
          môn mà còn rất tâm huyết. Thầy cô thường xuyên giới thiệu cho chúng em
          về văn hoá của các cộng đồng nói tiếng Hoa, chia sẻ các phương pháp
          ghi nhớ từ vựng hay và kể những câu chuyện thú vị về tiếng Hoa trong
          đời sống. Việc thầy cô giao tiếp gần gũi khiến chúng em nhanh chóng
          cảm thấy thoải mái, tự tin và sẵn sàng tham gia vào các hoạt động trên
          lớp.
        </p>
        <br />
        <p className="text-xl pl-3 font-semibold">
          Những gì thường diễn ra vào các buổi học?
        </p>
        {/* <p className="text-base indent-8 pl-3">
        ...
        <br />
        <p className="text-base indent-8 pl-3">
          Mỗi buổi học của chúng em thường bắt đầu bằng những bài luyện phát âm
          cơ bản. Thay vì học một cách khô khan, chúng em được hướng dẫn thông
          qua các ví dụ thực tế và các tình huống giao tiếp sinh động. Những
          thanh điệu tưởng chừng khó nhớ lại trở nên quen thuộc hơn sau khi được
          lặp đi lặp lại nhiều lần qua sự tương tác liên tục giữa các giáo viên
          và học sinh. Đôi lúc em cảm thấy rất áp lực rằng mình sẽ nói sai.
          Nhưng mỗi lần mắc lỗi, em đều được thầy cô chỉnh sửa nhẹ nhàng. Điều
          đó khiến em cảm thấy khích lệ, có động lực để học bài học hôm đó một
          cách cố gắng chú tâm.
        </p>
        <br />
        <p className="text-base indent-8 pl-3">
          Sau phần phát âm, chúng em thường được học từ vựng, ngữ pháp và đọc
          hiểu qua những câu chuyện nhỏ hoặc đoạn hội thoại. Ý nghĩa sâu sắc của
          mỗi chữ Hán, cách dùng từ trong từng bối cảnh khác nhau đều được các
          thầy cô giải đáp rõ ràng. Điều này giúp việc học không chỉ đơn thuần
          là ghi nhớ từ vựng hay ngữ pháp, mà còn là hiểu được “tính cách” và
          “linh hồn” của ngôn ngữ. Mỗi bài học đều mang lại cảm giác mới mẻ và
          kích thích sự tò mò.
        </p>
        <br />
        <p className="text-base indent-8 pl-3">
          Điều khiến chúng em ấn tượng nhất là tinh thần đồng hành của các bạn học.
